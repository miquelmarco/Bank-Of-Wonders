...
public class HomebankingApplication {
    ...
    public CommandLineRunner initData(ClientService clientService, AccountService accountService, TransactionService transactionService, LoanService loanService, ClientLoanService clientLoanService, CardService cardService) {
        return args -> {
            ...
            Account account1 = new Account("VIN001", LocalDate.now(), 0.0);
            Account account2 = new Account("VIN002", LocalDate.now(), 0.0);
            Account account3 = new Account("VIN003", LocalDate.now(), 0.0);
            Account account4 = new Account("VIN004", LocalDate.now(), 0.0);
            Transaction trans1 = new Transaction(5340.02, "retail purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans2 = new Transaction(482.02, "retail purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans3 = new Transaction(-5084.06, "supermarket purchase", TransactionType.DEBIT, LocalDateTime.now(),0.0);
            Transaction trans4 = new Transaction(4432.06, "retail purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans5 = new Transaction(965321.02, "retail purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans6 = new Transaction(-125480.15, "retail purchase", TransactionType.DEBIT, LocalDateTime.now(),0.0);
            Transaction trans7 = new Transaction(4421.02, "supermarket purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans8 = new Transaction(315.06, "retail purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans9 = new Transaction(-4215.03, "retail purchase", TransactionType.DEBIT, LocalDateTime.now(),0.0);
            Transaction trans10 = new Transaction(1544.82, "retail purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans11 = new Transaction(432.65, "supermarket purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans12 = new Transaction(814.21, "retail purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans13 = new Transaction(-32.25, "retail purchase", TransactionType.DEBIT, LocalDateTime.now(),0.0);
            Transaction trans14 = new Transaction(215.36, "supermarket purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            Transaction trans15 = new Transaction(-215.25, "retail purchase", TransactionType.DEBIT, LocalDateTime.now(),0.0);
            Transaction trans16 = new Transaction(1256.25, "retail purchase", TransactionType.CREDIT, LocalDateTime.now(),0.0);
            ...
            List<Card> addCardClient2 = Arrays.asList(card4);
            client2.addCards(addCardClient2);
            List<Card> addCardClient3 = Arrays.asList(card5);
